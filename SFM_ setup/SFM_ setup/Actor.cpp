...
void Actor::increaseFireRate()
{
	if (mFireRateLevel < 10)
		++mFireRateLevel;
}

void Actor::increaseSpread()
{
	if (mSpreadLevel < 3)
		++mSpreadLevel;
}

void Actor::collectMissiles(unsigned int count)
{
	mMissileAmmo += count;
}
...
void Actor::checkPickupDrop(CommandQueue& commands)
{
...
void Actor::checkProjectileLaunch(sf::Time dt, CommandQueue& commands)
{
...
void Actor::createBullets(SceneNode& node, const TextureHolder& textures) const
{
...
void Actor::createProjectile(SceneNode& node, Projectile::Type type, float xOffset, float yOffset, const TextureHolder& textures) const
{
...
void Actor::createPickup(SceneNode& node, const TextureHolder& textures) const
{
...
void Actor::updateRollAnimation()
{
